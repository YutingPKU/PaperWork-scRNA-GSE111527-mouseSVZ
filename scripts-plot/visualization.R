#README.md
#Home / GitHub / satijalab/seurat / R/visualization.R
#R/visualization.R
#In satijalab/seurat: Tools for Single Cell Genomics
#Defines functions SingleRasterMap SinglePolyPlot SingleImageMap SingleExIPlot SingleDimPlot SingleCorPlot SetQuantile SetHighlight ScaleColumn QuantileSegments PointLocator PlotBuild MakeLabels InvertHex geom_split_violin GetXYAesthetics GGpointToBase FacetTheme ExIPlot DefaultDimReduc Col2Hex BlendMatrix BlendMap BlendExpression Bandwidth AutoPointSize WhiteBackground BoldTitle RotatedAxis RestoreLegend SpatialTheme SeuratAxes NoGrid NoLegend NoAxes FontSize DarkTheme SeuratTheme PurpleAndYellow LabelPoints LabelClusters HoverLocator FeatureLocator DiscretePalette CustomPalette CombinePlots CollapseEmbeddingOutliers CellSelector BlueAndRed BlackAndWhite AugmentPlot VizDimLoadings PlotClusterTree JackStrawPlot ElbowPlot DotPlot BarcodeInflectionsPlot ALRAChooseKPlot PolyFeaturePlot PolyDimPlot VariableFeaturePlot FeatureScatter CellScatter FeaturePlot DimPlot ColorDimSplit VlnPlot RidgePlot HTOHeatmap DoHeatmap DimHeatmap
#Documented in ALRAChooseKPlot AugmentPlot BarcodeInflectionsPlot BlackAndWhite BlueAndRed BoldTitle CellScatter CellSelector CollapseEmbeddingOutliers ColorDimSplit CombinePlots CustomPalette DarkTheme DimHeatmap DimPlot DiscretePalette DoHeatmap DotPlot ElbowPlot FeatureLocator FeaturePlot FeatureScatter FontSize HoverLocator HTOHeatmap JackStrawPlot LabelClusters LabelPoints NoAxes NoGrid NoLegend PlotClusterTree PolyDimPlot PolyFeaturePlot PurpleAndYellow RestoreLegend RidgePlot RotatedAxis SeuratAxes SeuratTheme SpatialTheme VariableFeaturePlot VizDimLoadings VlnPlot WhiteBackground
...
satijalab/seurat documentation built on April 23, 2020, 10:54 p.m.
